...
/*function searchSuggestionContent() {
    ...
    if (d == "") {
        ...
        if (d == search_old || d == search_old2) {} else {
            ...
            search_old = d;
            $.get("/ware/searchSuggestion.action?", {
                keyword: d
            },
            function(i) {
                if (i != null) {

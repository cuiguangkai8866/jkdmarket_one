$(function() {
    ...
    function p(U) {
        if (U && U.ware && U.ware.images && U.ware.images.length > 0) {
            ...
            function(X, W) {
                if (W && W.newpath) {
                    V = V + W.newpath.replace("../n4/default.htm", "../n1/default.htm") + ","
                }
            });
            $("#imgs").val(V);
    ...
    function o(V) {
        ...
        if (V && V.yuYue && V.yuYue.isYuYue) {
            var U = "../../m.jd.com/yuyue/" + V.ware.wareId + ".html";
            $("#nowyuyue").attr("href", U);
            $("#cart1").css("display", "none");
            type = V.yuYue.yuyueType;
            if ("1" == V.yuYue.yuyueType) {
                ...
                if ("2" == V.yuYue.yuyueType) {
                    ...
                    if ("3" == V.yuYue.yuyueType) {
                        $("#test2").text(V.yuYue.buyStartTime);
                        $("#yuyuenow").css("display", "none");
                        $("#yuyuecart").css("display", "none");
                        $("#yuyueing").show();
                        ...
                        $("#yuyuetime").empty();
                        $("#yuyuecontext").empty();
                        if (parseInt(V.yuYue.buyStartTime) > 0) {
    ...
    function d(X) {
        ...
        $("#title").html(X.ware.wname + '&nbsp;&nbsp;<font color="red">' + X.ware.adword + "</font>");
        if (X && X.proColors && X.proColors.length > 0) {
            $("#color_parent").show();
            $("#color").empty();
            $.each(X.proColors,
            function(ab, aa) {
                if (X.ware.wareId == aa.wareId) {
                    $("#color1").html(aa.color);
                    $("#color").append('<a title="' + aa.color + '" date="current" class="btn-color-op new-mg-b10 on" >' + aa.color + "</a>&nbsp;")
                } else {
                    $("#color").append('<a title="' + aa.color + '" date="noCurrent" class="btn-color-op new-mg-b10" href="javascript:void(0)" wareId="' + aa.wareId + '">' + aa.color + "</a>&nbsp;")
                }
            })
        } else {
            $("#color_parent").hide()
        }
        if (X && X.proSizes && X.proSizes.length > 0) {
            $("#size_parent").show();
            $("#size").empty();
            $.each(X.proSizes,
            function(ab, aa) {
                if (X.ware.wareId == aa.wareId) {
                    ...
                    $("#size").append('<a title="' + aa.size + '" class="btn-color-op new-mg-b10" href="javascript:void(0)" date="noCurrentSize" wareId="' + aa.wareId + '">' + aa.size + "</a>&nbsp;")
                }
            })
        } else {
            $("#size_parent").hide()
        }
        if (X && X.ware && X.ware.marketPrice && X.ware.showMartPrice) {
            $("#marketPrice").empty;
            if (X.marketPrice) {
                $("#marketPrice").html("&yen;" + X.marketPrice)
            } else {
                $("#marketPrice").html("&yen;" + X.ware.marketPrice)
            }
        } else {
            $("#marketPrice").hide()
        }
        ...
        if (X && X.stock) {
            var W = "";
            if (X.stock.jdPrice && X.stock.jdPrice != "" && X.stock.jdPrice.toLowerCase() != "null" && parseFloat(X.stock.jdPrice) > 0) {
                W = "&yen;" + X.stock.jdPrice
            } else {
                W = "&#26242;&#26080;&#25253;&#20215;"
            }
            $("#price").html(W);
            ...
            var W = "";
            if (X.ware.jdPrice && X.ware.jdPrice != "" && X.ware.jdPrice.toLowerCase() != "null" && parseFloat(X.ware.jdPrice) > 0) {
                W = "&yen;" + X.ware.jdPrice
            } else {
                W = "&#26242;&#26080;&#25253;&#20215;"
            }
            $("#price").html(W);
        ...
        if (X && X.promotionInfo && X.promotionInfo.promotionInfoTitle) {
            $("#promotionInfo").show();
            $("#promotionInfo").empty();
        ...
        if (X && X.wareList && X.wareList.length > 0) {
            $("#wareList").show();
            $("#wareList_1").empty();
            for (var V = 0,
            U = X.wareList.length; V < U; V++) {
                $("#wareList_1").append('<a href="' + urlEncode("/product/" + X.wareList[V].wareId + ".html", $("#sid").val()) + '">' + X.wareList[V].wname + " X " + X.wareList[V].num + "</a>")
            }
        } else {
            $("#wareList").hide();
            $("#wareList_1").hide()
        }
        if (X && X.wareCoupons && X.wareCoupons.length > 0) {
            $("#wareCoupons").show();
            $("#wareCoupons_1").empty();
            for (var V = 0,
            U = X.wareCoupons.length; V < U; V++) {
                $("#wareCoupons_1").append("" + X.wareCoupons[V].message + (X.wareCoupons[V].balance ? " " + X.wareCoupons[V].balance + "&#20803;": "") + "")
            }
        } else {
            $("#wareCoupons").hide();
            $("#wareCoupons_1").hide()
    ...
    function A(X) {
        ...
        var V = -1;
        try {
            W = parseInt(X.commentCountMap.scoreCount1);
            V = W + parseInt(X.commentCountMap.scoreCount2) + parseInt(X.commentCountMap.scoreCount3)
        } catch(Y) {}
        var U = Math.round(W / V * 100);
        if (W >= 0 && V > 0) {
            $("#comments").html("<em>" + V + "</em> \u4eba\u8bc4\u4ef7  <em>" + U + "%</em> \u597d\u8bc4")
        } else {
            $("#comments").html("<em>" + V + "</em> \u4eba\u8bc4\u4ef7  <em> 100%</em> \u597d\u8bc4")
        }
    }
    function D(U) {
        if (U.orderCommentCount) {
            $("#orderNum").html(U.orderCommentCount + "&#26465;")
        }
    }
    function H(V) {
        var U = "";
    ...
    function v(W) {
        if (W && W.ware && W.ware.marketPrice && W.ware.showMartPrice) {
            $("#marketPrice").show();
            $("#marketPrice").empty();
            if (W.marketPrice) {
                $("#marketPrice").html("&yen;" + W.marketPrice)
            } else {
                $("#marketPrice").html("&yen;" + W.ware.marketPrice)
            }
        } else {
            $("#marketPrice").hide()
        }
        if (W.promotionInfo && W.promotionInfo.promotionInfoTitle.length > 0) {
            var U = W.promotionInfo.promotionInfoTitle + W.promotionInfo.promotionInfo;
        ...
        if (W && W.stock) {
            var V = "";
            if (W.stock.jdPrice && W.stock.jdPrice != "" && W.stock.jdPrice.toLowerCase() != "null" && parseFloat(W.stock.jdPrice) > 0) {
                V = "&yen;" + W.stock.jdPrice
            } else {
                V = "&#26242;&#26080;&#25253;&#20215;"
            }
            $("#price").html(V);
            ...
            var V = "";
            if (W.ware.jdPrice && W.ware.jdPrice != "" && W.ware.jdPrice.toLowerCase() != "null" && parseFloat(W.ware.jdPrice) > 0) {
                V = "&yen;" + W.ware.jdPrice
            } else {
                V = "&#26242;&#26080;&#25253;&#20215;"
            }
            $("#price").html(V);
    ...
    function J(U) {
        if (U) {
            ...
            $.each(U.provinceList,
            function(W, V) {
                if (V.label == U.province.id) {
                    $("#stockTip").append(U.province.name);
            ...
            if (U.city) {
                ...
                $.each(U.cityList,
                function(W, V) {
                    if (V.label == U.city.id) {
                        $("#stockTip").append(">" + U.city.name);
            ...
            if (U.country) {
                ...
                $.each(U.countryList,
                function(W, V) {
                    if (V.label == U.country.id) {
                        $("#stockTip").append(">" + U.country.name);
            ...
            if (U.town) {
                ...
                $.each(U.townList,
                function(W, V) {
                    if (V.label == U.town.id) {
                        $("#stockTip").append(">" + U.town.name);
            ...
            if (U.stock && U.stock.status) {
                $("#stockStatus").html('<font color="#c00">' + U.stock.status + "</font>");
                $("#stockStatus_1").html(U.stock.status)
            }
        } else {
            $("#store").hide()
        }
        if (U && U.canBuy && U.stock && U.stock.flag) {
            if ((U.stock.jdPrice > 0) || (U.ware.jdprice > 0)) {
                if ($("#teamSign").val() != 1) {
                    $("#add_cart").removeClass("btn-cart-def");
    ...
    var f = null;
    function R() {
        var U = parseInt(document.body.clientWidth);
    ...
    function O() {
        ...
        V.setAttribute("style", "position:absolute;left:0px;top:0px;background-color:rgb(0, 0, 0);filter:alpha(opacity=90);opacity: 0.9;width:" + W + ";height:" + U + ";z-index:8889;"); (document.body || document.documentElement).appendChild(V);
...
$(function() {
    ...
    $.post(urlEncode("../ware/comments.json", _sid), {
        wareId: _wareId
    },
    function(d) {
        var good = -1;
    ...
    "json");
    $.post(urlEncode("../ware/orderComment.json", _sid), {
        wareId: _wareId
    },
    function(d) {
    ...
    "json");
    $.post(urlEncode("../ware/consultations.json", _sid), {
        wareId: _wareId
    },
    function(d) {
        var html = "";
    ...
    $("#attention").click(function() {
        if ($("#attention").hasClass("on")) {
            $.ajax({
                url: urlEncode("../user/cancelFavorite.json", _sid),
                data: {
                    wareId: $("#currentWareId").val()
                },
                success: function(d) {
            ...
            $.ajax({
                url: urlEncode("/user/addFavorite.json", _sid),
                data: {
                    wareId: $("#currentWareId").val()
                },
                success: function(d) {
...
function changeProvince() {
    var a = document.getElementById("province").selectedIndex;
...
function changeCity() {
    var a = document.getElementById("city").selectedIndex;
...
function changeTown() {
    var a = document.getElementById("town").selectedIndex;
...
$(function() {
    $("#btnDetail").click(function() {
        ...
        if (b == $("#showdetail").attr("wareId")) {
            return
        }
        $("#detailContent").html(loading);
        $("#showdetail").attr("wareId", b);
        $.get("/ware/detail.json", {
            wareId: b,
            sid: a
        },
        function(f) {
            var e = "";
            if (f && f.ware && f.ware.isbook) {
                e = e + '<div class="new-gd-introduce"><h3 class="new-h-h3 new-mg-b10">&#22522;&#26412;&#20449;&#24687;</h3>';
                if (f && f.ware && f.ware.attrs) {
                    for (var d = 0,
                    c = f.ware.attrs.length; d < c; d++) {
                        e += '<span class="new-span-block">' + f.ware.attrs[d].label + " " + f.ware.attrs[d].value + "</span>"
                    }
                }
                e = e + '</div><div class="new-gd-introduce"><h3 class="new-h-h3 new-mg-tb10">&#22270;&#20070;&#20869;&#23481;</h3>';
                if (f.ware.wdis && f.ware.wdis.length > 0) {
                    e += ('<p class=" new-mg-b10">' + f.ware.wdis + "</p>")
                } else {
                    e += '<p class=" new-mg-b10">&#26242;&#26080;&#20171;&#32461;</p>'
                }
                e = e + '</div><div class="new-gd-introduce"><h3 class="new-h-h3 new-mg-tb10">&#30446;&#24405;</h3><span class="new-span-block">' + (f.ware.catalogue.replace(/\n/g, "<br/>")) + "</span></div>"
            } else {
                e = e + '<div class="new-gd-introduce"><h3 class="new-h-h3 new-mg-tb10">&#21830;&#21697;&#20171;&#32461;</h3>';
                if (f.ware.wdis && f.ware.wdis.length > 0) {
                    e += ('<p class=" new-mg-b10">' + f.ware.wdis + "</p>")
                } else {
                    e += '<p class=" new-mg-b10">&#26242;&#26080;&#20171;&#32461;</p>'
                }
                e = e + '</div><div class="new-gd-introduce"><h3 class="new-h-h3 new-mg-tb10">&#35268;&#26684;&#21442;&#25968;</h3>';
                if (f.ware.wi && f.ware.wi.code && f.ware.wi.code.length > 0) {
                    e += ('<p class=" new-mg-b10">' + f.ware.wi.code + "</p>")
                } else {
                    e += '<p class=" new-mg-b10">&#26242;&#26080;</p>'
                }
                e = e + '</div><div class="new-gd-introduce"><h3 class="new-h-h3 new-mg-tb10">&#21253;&#35013;&#28165;&#21333;</h3>';
                if (f.ware.wi && f.ware.wi.wareQD && f.ware.wi.wareQD.length > 0) {
                    e += ('<p class=" new-mg-b10">' + f.ware.wi.wareQD + "</p>")
                } else {
                    e += '<p class=" new-mg-b10">&#26242;&#26080;</p>'
                }
                e = e + '</div><div class="new-gd-introduce new-border-none"><h3 class="new-h-h3 new-mg-tb10">&#21806;&#21518;&#26381;&#21153;</h3>';
                if (f.ware.wi && f.ware.wi.ybInfo && f.ware.wi.ybInfo.length > 0) {
                    e += ('<p class=" new-mg-b10">' + f.ware.wi.ybInfo + "</p>")
                } else {
                    e += '<p class=" new-mg-b10">&#26242;&#26080;</p>'
                }
                e = e + "</div>"
...
function assessRender(c) {
    ...
    if ($("#_tabGoodScale").hasClass("on")) {
        ...
        if ($("#_tabMediumScale").hasClass("on")) {
            d = 3
        } else {
            if ($("#_tabBadScale").hasClass("on")) {
                d = 1
            }
        }
    }
    ...
    function(x) {
        ...
        if (m == 0 && x.comments.length != 0) {
            m = x.comments.length
        }
        if (x.commentCountMap) {
            var r = x.commentCountMap.scoreCount1;
        ...
        if (x.comments && x.comments.length > 0) {
            var q = "";
            for (var v = 0,
            w = x.comments.length; v < w; v++) {
                var f = x.comments[v];
                var g = f.userId || "";
                if (g.length > 10) {
                    g = f.userId.substring(0, 10) + "..."
                }
                var l = urlEncode("/ware/commentDetail/" + e + "_" + f.commentId + ".html", k);
                q = q + '<div class="new-gd-introduce" onclick="window.location.href=\'' + l + '\'"><div class="new-mg-t10">' + (f.pros != "" && f.pros != "没有描述" ? '<span class="new-gd-txt2"><span class="new-fl">&#20248;&#28857;&#65306;</span><span class="new-gd-txt3">' + f.pros + "</span></span>": "") + (f.cons != "" && f.cons != "没有描述" ? '<span class="new-gd-txt2"><span class="new-fl">&#19981;&#36275;&#65306;</span><span class="new-gd-txt3">' + f.cons + "</span></span>": "") + (f.content != "" && f.content != "没有描述" ? '<span class="new-gd-txt2"><span class="new-fl">&#24515;&#24471;&#65306;</span><span class="new-gd-txt3">' + f.content + "</span></span>": "") + '</div><div class="new-p-re new-mg-t10"><span class="new-mu-star"><span class="new-mu-starv" style="width:' + (f.score * 20) + '%"></span></span><span class="new-gd-user">' + g + " " + (f.creationTime.length > 10 ? f.creationTime.substring(0, 10) : f.creationTime) + "</span></div></div>"
            }
            $("#_assessItem").html(q)
        } else {
            $("#_assessItem").html('<div class="new-cp-prom2"><span class="new-logo2"></span><strong class="new-span-block">&#25265;&#27465;&#26242;&#26102;&#27809;&#26377;&#30456;&#20851;&#32467;&#26524;</strong></div>')
        ...
        var t = assessPageNo;
        if (h > 0) {
            var q = '<div class="new-tbl-type"><div class="new-tbl-cell">' + (assessPageNo != 1 ? '<a href="javascript:prevAssess()" class="new-a-prve"><span>&#19978;&#19968;&#39029;</span></a>': '<span class="new-a-prve"><span>&#19978;&#19968;&#39029;</span></span>') + '</div><div class="new-tbl-cell new-p-re"><div class="new-a-page"><span class="new-open">' + assessPageNo + "/" + h + '</span></div><select class="new-select" id="_assessSelectNo" onchange = "goSelectPage()">';
            for (var v = 0; v < h; v++) {
                q += '<option value="' + (v + 1) + '" ' + (v + 1 == t ? "selected": "") + ">&#31532;" + (v + 1) + "&#39029;</option>"
            }
            q = q + '</select></div><div class="new-tbl-cell">' + (t != h ? '<a href="javascript:nextAssess()" class="new-a-next"><span>&#19979;&#19968;&#39029;</span></a>': '<span class="new-a-next"><span>&#19979;&#19968;&#39029;</span></span>') + "</div></div>";
            $("#_assessPage").html(q)
        } else {
            $("#_assessPage").html("")
        }
...
function changeAssessType(a) {
    var b = a.id;
    if (b != "_tabGoodScale") {
        $("#_tabGoodScale").removeClass("on")
    }
    if (b != "_tabMediumScale") {

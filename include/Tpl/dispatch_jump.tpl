    ...
    <head>
        ...
        <style type="text/css">
            *{ padding: 0; margin: 0; }
            ...
            .system-message .success,.system-message .error{ line-height: 1.8em; font-size: 35px }
            .system-message .success{ color:#3}
    ...
    <body>
        <div class="system-message">
            <present name="message">
                <h1 class="success" style="font-size:80px; color:#ffffff;">√</h1>
                <p class="success"><?php echo($message); ?></p>
                <else/>
                <h1 class="error" style="font-size:80px; color:#ffffff;">x</h1>

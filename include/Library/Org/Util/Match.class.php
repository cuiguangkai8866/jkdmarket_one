...
class Match{
    ...
    function emailExp($str){
         ...
         */
        $RegExp = '/^[a-zA-Z0-9][a-zA-Z0-9._-]*\@[a-zA-Z0-9]+\.[a-zA-Z0-9\.]+$/A';
        $result = preg_match($RegExp,$str);
        return $result;
    }
    function telExp($str){
         ...
         */
        $RegExp = '/^(\(((010)|(021)|(0\d{3,4}))\)( ?)([0-9]{7,8}))|((010|021|0\d{3,4}))([- ]{1,2})([0-9]{7,8})$/A';
        $result = preg_match($RegExp,$str);
        return $result;
    }
    function urlExp($str){
         ...
         */
        $RegExp = '/^(([a-zA-Z]+)(:\/\/))?([a-zA-Z]+)\.(\w+)\.([\w.]+)(\/([\w]+)\/?)*(\/[a-zA-Z0-9]+\.(\w+))*(\/([\w]+)\/?)*(\?(\w+=?[\w]*))*((&?\w+=?[\w]*))*$/';
        $result = preg_match($RegExp,$str);
        return $result;
    }
    function icExp($str){
         ...
         */
        $RegExp = '/^(([0-9]{15})|([0-9]{18})|([0-9]{17}x))$/';
        $result = preg_match($RegExp,$str);
        return $result;
    }
    function postcodeExp($str){
        /**
        匹配邮编
        规则：六位数字，第一位不能为0
         */
    ...
    function ipExp($str){
        ...
        四个参数必须存在
         */
        $RegExp = '/^((([1-9])|((0[1-9])|([1-9][0-9]))|((00[1-9])|(0[1-9][0-9])|((1[0-9]{2})|(2[0-4][0-9])|(25[0-5]))))\.)((([0-9]{1,2})|(([0-1][0-9]{2})|(2[0-4][0-9])|(25[0-5])))\.){2}(([1-9])|((0[1-9])|([1-9][0-9]))|(00[1-9])|(0[1-9][0-9])|((1[0-9]{2})|(2[0-4][0-9])|(25[0-5])))$/';
        $result = preg_match($RegExp,$str);
        return $result;
    }
    function chineseExp($str){
        //utf8下匹配中文
    ...
    function timeExp($str){
         ...
         */
        $RegExp ='/^(([1-2][0-9]{3}-)((([1-9])|(0[1-9])|(1[0-2]))-)((([1-9])|(0[1-9])|([1-2][0-9])|(3[0-1]))))( ((([0-9])|(([0-1][0-9])|(2[0-3]))):(([0-9])|([0-5][0-9]))(:(([0-9])|([0-5][0-9])))?))?$/';
        $result = preg_match($RegExp,$str);
        return $result;
    }
}
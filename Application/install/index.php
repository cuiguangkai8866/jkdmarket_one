...
define("VERSION", date('Y-m-d',time()).' Author By AresAults');
...
switch ($step) {
    ...
    case '4':
        if (intval($_GET['install'])) {
            ...
            $config['SITE_INFO']['version'] = '九口袋企业CMS'; //描述
            $config['SITE_INFO']['url'] = trim($_POST['siteurl']); //描述
            $config['SITE_INFO']['icp'] = ''; //描述
            $config['SITE_INFO']['service'] = ''; //描述
            $config['SITE_INFO']['tel'] = ''; //描述
            $config['SITE_INFO']['fax'] = ''; //描述
            $config['SITE_INFO']['qq'] = ''; //描述
            $config['SITE_INFO']['address'] = '上海嘉乐园大厦2222号'; //描述
            $config['SITE_INFO']['postcode'] = ''; //描述
            $config['SITE_INFO']['notice'] = ''; //描述
            $config['SITE_INFO']['tongji'] = ''; //描述
            $config['SITE_INFO']['fenxiang'] = ''; //描述
            ...
            $config['TOKEN']['admin_marked'] = 'http://www.9koudai.cn'; //
            $config['TOKEN']['admin_timeout'] = '3600'; //
            $config['TOKEN']['member_marked'] = 'http://www.9koudai.cn'; //
            $config['TOKEN']['member_timeout'] = '3600'; //
            ...
            $config['SYSTEM_EMAIL']['smtp_host'] = '';
            $config['SYSTEM_EMAIL']['smtp_port'] = '';
            $config['SYSTEM_EMAIL']['from_email'] = '';
            $config['SYSTEM_EMAIL']['from_name'] = '';
            $config['SYSTEM_EMAIL']['smtp_user'] = '';
            $config['SYSTEM_EMAIL']['smtp_pass'] = '';
            $config['SYSTEM_EMAIL']['replay_email'] = '';
            $config['SYSTEM_EMAIL']['replay_name'] = '';
            $config['SYSTEM_EMAIL']['test_email'] = '';
            ...
            $time = time();
            $query = "INSERT INTO `{$dbPrefix}admin` VALUES ('1', '超级管理员', '{$email}','{$password}',1,  '我是超级管理员',NULL, $time);";
            mysql_query($query);
